...
Click an application row to open its detail page at `/software/{appId}`. The page shows the header (name, icon, status, monthly cost, detected logins, end of contract), overview (description, category, vendor, source, stakeholders), licenses table, and users table.
