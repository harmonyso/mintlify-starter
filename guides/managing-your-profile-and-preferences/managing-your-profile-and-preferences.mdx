...
{/* IMAGE: User menu in sidebar footer → /guides/managing-your-profile-and-preferences/screenshots/user-menu.png | UI: frontend-app/src/components/layout/app-sidebar/user-sidebar-menu.tsx | Route: /dashboard */}
...
{/* IMAGE: Preferences page with Theme and other settings → /guides/managing-your-profile-and-preferences/screenshots/preferences-theme.png | UI: frontend-app/src/features/settings/components/preferences/preferences-pane.tsx | Route: /settings/preferences */}
...
{/* IMAGE: Settings > Preferences with desk visibility checkboxes → /guides/managing-your-profile-and-preferences/screenshots/desk-visibility-preferences.png | UI: frontend-app/src/features/settings/components/preferences/preferences-pane.tsx, desk-visibility-section.tsx | Route: /settings/preferences */}
