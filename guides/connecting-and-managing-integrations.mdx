...
{/* IMAGE: Settings > Integrations with Connect on card → /images/guides/connecting-and-managing-integrations/integrations-connect.png | UI: frontend-app/src/features/settings/components/integrations/integrations-pane.tsx, integration-card.tsx | Route: /settings/integrations */}
...
{/* IMAGE: OAuth popup or provider approval page → /images/guides/connecting-and-managing-integrations/oauth-authorization.png | UI: External provider (Slack, Okta, etc.) auth screen — captured during Connect flow | Route: /settings/integrations */}
...
{/* IMAGE: Integration config modal with form fields and Save Changes → /images/guides/connecting-and-managing-integrations/integration-config-form.png | UI: frontend-app/src/features/settings/components/integrations/integration-config-modal.tsx | Route: /settings/integrations */}
...
{/* IMAGE: Multi-instance modal with Add instance and instance list → /images/guides/connecting-and-managing-integrations/multi-instance-modal.png | UI: frontend-app/src/features/settings/components/integrations/multi-instance-integration-modal.tsx | Route: /settings/integrations */}
