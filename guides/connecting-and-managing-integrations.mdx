...
![Settings > Integrations with integration cards](/images/guides/connecting-and-managing-integrations/integrations-connect.png)
...
![OAuth authorization page (Slack, Okta, etc.) — captured manually during Connect flow](/images/guides/connecting-and-managing-integrations/oauth-authorization.png)
...
![Integration config modal with form fields and Save Changes](/images/guides/connecting-and-managing-integrations/integration-config-form.png)
...
![Multi-instance modal with Create instance and instance list](/images/guides/connecting-and-managing-integrations/multi-instance-modal.png)
