...
{/* IMAGE: Dashboard with Tickets Opened, Open Tickets, SLA Breached widgets → /images/guides/analyzing-service-desk-metrics/overview-widgets.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#total-tickets, open-tickets-now, unassigned-tickets-now, sla-breached-now | Route: /dashboard */}
...
{/* IMAGE: Opened vs Resolved Tickets chart → /images/guides/analyzing-service-desk-metrics/opened-vs-resolved.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#opened-vs-resolved | Route: /dashboard */}
...
{/* IMAGE: Response vs Resolution Time chart → /images/guides/analyzing-service-desk-metrics/response-vs-resolution.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#response-vs-resolution | Route: /dashboard */}
...
{/* IMAGE: SLA Compliance Trend stacked chart → /images/guides/analyzing-service-desk-metrics/sla-compliance-chart.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#sla-compliance | Route: /dashboard */}
...
{/* IMAGE: Ticket status donut/bar chart → /images/guides/analyzing-service-desk-metrics/breakdown-status.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#ticket-breakdown | Route: /dashboard */}
...
{/* IMAGE: Ticket Breakdown by Priority chart → /images/guides/analyzing-service-desk-metrics/breakdown-priority.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#ticket-priority | Route: /dashboard */}
...
{/* IMAGE: User Satisfaction widget → /images/guides/analyzing-service-desk-metrics/user-satisfaction.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#user-satisfaction | Route: /dashboard */}
