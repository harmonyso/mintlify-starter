...
{/* IMAGE: Main sidebar with main sections → /images/guides/getting-started-with-harmony-dashboard/sidebar-sections.png | UI: frontend-app/src/components/layout/app-sidebar/index.tsx | Route: /dashboard */}
...
{/* IMAGE: Default dashboard home view with widgets → /images/guides/getting-started-with-harmony-dashboard/dashboard-home.png | UI: frontend-app/src/features/dashboard/components/dashboard-page.tsx, dashboard-grid.tsx | Route: /dashboard */}
...
{/* IMAGE: Command palette open with search → /images/guides/getting-started-with-harmony-dashboard/command-palette.png | UI: frontend-app/src/components/command-palette/command-palette.tsx | Route: /dashboard */}
