...
![Dashboard widget with compliance segments](/guides/analyzing-asset-and-automation-metrics/screenshots/asset-compliance-widget.png)
...
![Asset distribution widgets (By Vendor, By Model Family)](/guides/analyzing-asset-and-automation-metrics/screenshots/asset-distribution-widgets.png)
...
![Asset Breakdown by Status widget (lifecycle)](/guides/analyzing-asset-and-automation-metrics/screenshots/asset-status-widget.png)
...
![Asset age breakdown chart](/guides/analyzing-asset-and-automation-metrics/screenshots/asset-age-chart.png)
...
![Software status donut chart](/guides/analyzing-asset-and-automation-metrics/screenshots/software-status-chart.png)
...
![AI vs Human Resolution chart (deflection/escalation)](/guides/analyzing-asset-and-automation-metrics/screenshots/ai-vs-human-resolution.png)
...
![Agent Runs by Status widget (Completed/Failed/Cancelled)](/guides/analyzing-asset-and-automation-metrics/screenshots/agent-runs-status.png)
...
![Workflow Runs by Status widget](/guides/analyzing-asset-and-automation-metrics/screenshots/workflow-runs-status.png)
