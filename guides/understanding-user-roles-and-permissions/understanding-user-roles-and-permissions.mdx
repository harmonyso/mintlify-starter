...
![User detail pane with Groups, Desks, and role badges](/guides/understanding-user-roles-and-permissions/screenshots/user-roles-badges.png)
...
![Users table with Role column badges](/guides/understanding-user-roles-and-permissions/screenshots/users-table-role-column.png)
