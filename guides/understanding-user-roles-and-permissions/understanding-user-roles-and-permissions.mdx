...
{/* IMAGE: User detail pane with Groups, Desks, and role badges → /guides/understanding-user-roles-and-permissions/screenshots/user-roles-badges.png | UI: frontend-app/src/features/settings/components/user-management/user-detail-pane.tsx | Route: /settings/user-management/$userId */}
...
{/* IMAGE: Users table with Role column badges → /guides/understanding-user-roles-and-permissions/screenshots/users-table-role-column.png | UI: frontend-app/src/features/settings/components/user-management/users-tab.tsx, users-columns.tsx | Route: /settings/user-management */}
