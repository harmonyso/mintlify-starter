...
{/* IMAGE: Custom fields list and Create custom field → /images/guides/managing-ticket-settings/custom-fields.png | UI: frontend-app/src/features/settings/components/tickets/tickets-pane.tsx, custom-fields/custom-field-modal.tsx | Route: /settings/desks/$deskId/tickets */}
...
{/* IMAGE: Tags section with Create tag and color palette → /images/guides/managing-ticket-settings/tags-section.png | UI: frontend-app/src/features/settings/components/tickets/tickets-pane.tsx, tag-modal.tsx | Route: /settings/desks/$deskId/tickets */}
...
{/* IMAGE: Canned responses section with Create template → /images/guides/managing-ticket-settings/canned-responses.png | UI: frontend-app/src/features/settings/components/tickets/canned-responses-section.tsx | Route: /settings/desks/$deskId/templates */}
