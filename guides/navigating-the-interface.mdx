...
The Harmony layout uses a collapsible sidebar on the left, main content in the center, and a user menu in the sidebar footer. The layout adapts for mobile. When you're on the Portal (`/portal`), the sidebar is hidden and a different layout is shown.
