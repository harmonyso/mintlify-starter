...
{/* IMAGE: Full layout with sidebar expanded → /images/guides/navigating-the-interface/layout-full.png | UI: frontend-app/src/components/layout/app-layout/index.tsx, app-sidebar/index.tsx | Route: /dashboard */}
...
{/* IMAGE: Sidebar collapsed with desk hover card → /images/guides/navigating-the-interface/desk-hover-preview.png | UI: frontend-app/src/components/layout/app-sidebar/desk-with-teams-hover-item.tsx, tickets-menu-item.tsx | Route: /dashboard */}
...
{/* IMAGE: Command palette with search results → /images/guides/navigating-the-interface/command-palette.png | UI: frontend-app/src/core/command-palette | Route: / (Cmd+K from anywhere) */}
...
{/* IMAGE: Breadcrumbs on Settings desk page → /images/guides/navigating-the-interface/breadcrumbs.png | UI: frontend-app/src/features/settings/components/desks/desk-settings-layout.tsx | Route: /settings/desks/$deskId */}
...
{/* IMAGE: User menu dropdown in sidebar footer → /images/guides/navigating-the-interface/user-menu.png | UI: frontend-app/src/components/layout/app-sidebar/user-sidebar-menu.tsx | Route: /dashboard */}
