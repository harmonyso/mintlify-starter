...
![Ticket table with filter popover](/guides/organizing-tickets-and-table-views/screenshots/ticket-filters.png)
...
![Ticket table with sortable column headers](/guides/organizing-tickets-and-table-views/screenshots/ticket-table-sorting.png)
...
![View dropdown with Save current view](/guides/organizing-tickets-and-table-views/screenshots/saved-views-dropdown.png)
...
![Manage columns dropdown with column checkboxes](/guides/organizing-tickets-and-table-views/screenshots/manage-columns.png)
...
![Ticket table with selection and bulk action toolbar](/guides/organizing-tickets-and-table-views/screenshots/ticket-bulk-actions.png)
