...
{/* IMAGE: Ticket table with filter popover → /guides/organizing-tickets-and-table-views/screenshots/ticket-filters.png | UI: frontend-app/src/routes/tickets/desk.$deskId.tsx, components/common/data-table/data-table-toolbar.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Ticket table with sortable column headers → /guides/organizing-tickets-and-table-views/screenshots/ticket-table-sorting.png | UI: frontend-app/src/routes/tickets/desk.$deskId.tsx, components/common/data-table | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: View dropdown with Save current view → /guides/organizing-tickets-and-table-views/screenshots/saved-views-dropdown.png | UI: frontend-app/src/features/service-desk/components/ticket-views-dropdown.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Manage columns dropdown with column checkboxes → /guides/organizing-tickets-and-table-views/screenshots/manage-columns.png | UI: frontend-app/src/components/common/data-table/data-table-view-options.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Ticket table with selection and bulk action toolbar → /guides/organizing-tickets-and-table-views/screenshots/ticket-bulk-actions.png | UI: frontend-app/src/features/service-desk/components/tickets-bulk-actions.tsx | Route: /tickets/desk/$deskId */}
