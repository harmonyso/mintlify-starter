...
![EOL policy form with asset type, lifecycle, and notification settings](/images/guides/configuring-asset-management/eol-policy-form.png)
...
![EOL notifications pane with destinations](/images/guides/configuring-asset-management/eol-notifications.png)
...
![Low stock alert form with asset type and threshold](/images/guides/configuring-asset-management/low-stock-alert-form.png)
...
![Discovery policy with vendor/model and network rules](/images/guides/configuring-asset-management/discovery-policy.png)
