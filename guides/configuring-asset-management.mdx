...
{/* IMAGE: EOL policy form with asset type, lifecycle, notification → /images/guides/configuring-asset-management/eol-policy-form.png | UI: frontend-app/src/features/settings/components/asset-management/eol-policies/eol-policy-form-modal.tsx | Route: /settings/asset-management */}
...
{/* IMAGE: EOL notifications pane with destinations → /images/guides/configuring-asset-management/eol-notifications.png | UI: frontend-app/src/features/settings/components/asset-management/eol-notifications/eol-notifications-pane.tsx | Route: /settings/asset-management */}
...
{/* IMAGE: Low stock alert form with threshold → /images/guides/configuring-asset-management/low-stock-alert-form.png | UI: frontend-app/src/features/settings/components/asset-management/low-stock-alerts/low-stock-alert-form-modal.tsx | Route: /settings/asset-management */}
...
{/* IMAGE: Discovery policy with vendor/model and network rules → /images/guides/configuring-asset-management/discovery-policy.png | UI: frontend-app/src/features/settings/components/asset-management/discovery-policies | Route: /settings/asset-management */}
