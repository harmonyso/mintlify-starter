...
{/* IMAGE: Dashboard widget with compliance segments → /images/guides/analyzing-asset-and-automation-metrics/asset-compliance-widget.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#asset-breakdown-by-compliance | Route: /dashboard */}

### Viewing Asset Distribution

Add these widgets from the Widget Library to analyze asset distribution:
...
{/* IMAGE: Asset distribution widgets (By Vendor, By Model Family) → /images/guides/analyzing-asset-and-automation-metrics/asset-distribution-widgets.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#asset-breakdown-by-vendor, asset-breakdown-by-model-family | Route: /dashboard */}
...
{/* IMAGE: Asset Breakdown by Status widget (lifecycle) → /images/guides/analyzing-asset-and-automation-metrics/asset-status-widget.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#asset-breakdown-by-status | Route: /dashboard */}
...
{/* IMAGE: Asset age breakdown chart → /images/guides/analyzing-asset-and-automation-metrics/asset-age-chart.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#asset-breakdown-by-age | Route: /dashboard */}
...
{/* IMAGE: Software status donut chart → /images/guides/analyzing-asset-and-automation-metrics/software-status-chart.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#software-breakdown | Route: /dashboard */}
...
{/* IMAGE: AI vs Human Resolution chart (deflection/escalation) → /images/guides/analyzing-asset-and-automation-metrics/ai-vs-human-resolution.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#ai-resolved-vs-escalated | Route: /dashboard */}
...
{/* IMAGE: Agent Runs by Status widget (Completed/Failed/Cancelled) → /images/guides/analyzing-asset-and-automation-metrics/agent-runs-status.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#agent-ended-by-status | Route: /dashboard */}
...
{/* IMAGE: Workflow Runs by Status widget → /images/guides/analyzing-asset-and-automation-metrics/workflow-runs-status.png | UI: frontend-app/src/features/dashboard/components/widgets/widgets.ts#workflow-ended-by-status | Route: /dashboard */}
