...
{/* IMAGE: People data table with toolbar and filters → /images/guides/managing-people/people-list.png | UI: frontend-app/src/routes/people/index.tsx | Route: /people */}
...
{/* IMAGE: Employee profile with Overview tab → /images/guides/managing-people/employee-profile.png | UI: frontend-app/src/routes/people/$employeeId.tsx | Route: /people/$employeeId */}
...
{/* IMAGE: Manage Groups dialog with group selector → /images/guides/managing-people/manage-groups-dialog.png | UI: frontend-app/src/features/people/components/employee-details/manage-groups-dialog.tsx | Route: /people/$employeeId */}
...
{/* IMAGE: People toolbar with Export button → /images/guides/managing-people/people-toolbar-export.png | UI: frontend-app/src/routes/people/index.tsx | Route: /people */}
