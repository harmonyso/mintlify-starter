...
{/* IMAGE: Settings > User Management > Users tab → /guides/managing-user-management/screenshots/users-tab.png | UI: frontend-app/src/features/settings/components/user-management/users-tab.tsx | Route: /settings/user-management */}
...
{/* IMAGE: Groups tab with Import group button → /guides/managing-user-management/screenshots/groups-tab.png | UI: frontend-app/src/features/settings/components/user-management/groups-tab.tsx | Route: /settings/user-management */}
...
{/* IMAGE: Import group modal with IdP dropdown → /guides/managing-user-management/screenshots/import-group-modal.png | UI: frontend-app/src/features/settings/components/user-management/import-group-modal.tsx | Route: /settings/user-management */}
...
{/* IMAGE: Add destination with Slack, Teams, Email options → /guides/managing-user-management/screenshots/add-destination.png | UI: frontend-app/src/features/settings/components/shared/destinations/add-destination-button.tsx, destinations-pane.tsx | Route: /settings/desks/$deskId/notifications */}
