...
{/* IMAGE: Workflows list with cards (name, enabled toggle) → /images/guides/building-and-managing-workflows/workflows-list.png | UI: frontend-app/src/routes/workflows/index.tsx, workflow-card.tsx | Route: /workflows */}
...
{/* IMAGE: Workflow canvas with trigger node and step selector → /images/guides/building-and-managing-workflows/workflow-canvas.png | UI: frontend-app/src/features/workflow-builder/components/workflow-canvas.tsx | Route: /workflows/new or /workflows/$workflowId/edit */}
...
{/* IMAGE: Step selector with categories (Slack, Okta, Harmony) → /images/guides/building-and-managing-workflows/workflow-step-selector.png | UI: frontend-app/src/features/workflow-builder/components/properties-panel.tsx#StepSelector | Route: /workflows/$workflowId/edit */}
...
{/* IMAGE: Condition block with true/false branches → /images/guides/building-and-managing-workflows/condition-block.png | UI: frontend-app/src/features/workflow-builder (Logic category, Condition block) | Route: /workflows/$workflowId/edit */}
...
{/* IMAGE: Template picker or token input with {{ variables → /images/guides/building-and-managing-workflows/template-picker.png | UI: frontend-app/src/features/workflow-builder/blocks/components/token-input.tsx | Route: /workflows/$workflowId/edit */}
...
{/* IMAGE: Runs drawer with run history and step details → /images/guides/building-and-managing-workflows/runs-drawer.png | UI: frontend-app/src/features/workflow-builder/components/runs-drawer.tsx | Route: /workflows/$workflowId/edit */}
...
{/* IMAGE: Workflow toolbar (Back, Run, Save, Settings, Enabled) → /images/guides/building-and-managing-workflows/workflow-toolbar.png | UI: frontend-app/src/features/workflow-builder/components/workflow-toolbar.tsx | Route: /workflows/$workflowId/edit */}
...
{/* IMAGE: Properties panel with node configuration form → /images/guides/building-and-managing-workflows/properties-panel.png | UI: frontend-app/src/features/workflow-builder/components/properties-panel.tsx | Route: /workflows/$workflowId/edit */}
