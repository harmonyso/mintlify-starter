...
{/* IMAGE: Dashboard dropdown with Create dashboard → /images/guides/creating-and-managing-custom-dashboards/dashboard-dropdown-create.png | UI: frontend-app/src/features/dashboard/components/dashboard-dropdown.tsx | Route: /dashboard */}
...
{/* IMAGE: Dashboard list with star icon for default → /images/guides/creating-and-managing-custom-dashboards/dashboard-default-star.png | UI: frontend-app/src/features/dashboard/components/dashboard-dropdown.tsx | Route: /dashboard */}
...
{/* IMAGE: Dashboard dropdown with copy icon for duplicate → /images/guides/creating-and-managing-custom-dashboards/dashboard-duplicate.png | UI: frontend-app/src/features/dashboard/components/dashboard-dropdown.tsx | Route: /dashboard */}
...
{/* IMAGE: Edit mode with Delete button in header → /images/guides/creating-and-managing-custom-dashboards/dashboard-edit-delete.png | UI: frontend-app/src/features/dashboard/components/dashboard-header.tsx | Route: /dashboard/$dashboardId */}

## Related Resources

<CardGroup cols={2}>
  <Card title="Dashboard Widgets" icon="grid-2" href="/guides/working-with-dashboard-widgets" />
