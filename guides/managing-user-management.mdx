...
{/* IMAGE: Settings > User Management > Users tab → /images/guides/managing-user-management/users-tab.png | UI: frontend-app/src/features/settings/components/user-management/users-tab.tsx | Route: /settings/user-management */}
...
{/* IMAGE: User detail pane with Groups and Desks → /images/guides/managing-user-management/user-detail-pane.png | UI: frontend-app/src/features/settings/components/user-management/user-detail-pane.tsx | Route: /settings/user-management/$userId */}
...
{/* IMAGE: Groups tab with Import group button → /images/guides/managing-user-management/groups-tab.png | UI: frontend-app/src/features/settings/components/user-management/groups-tab.tsx | Route: /settings/user-management */}
...
{/* IMAGE: Import group modal with IdP dropdown → /images/guides/managing-user-management/import-group-modal.png | UI: frontend-app/src/features/settings/components/user-management/import-group-modal.tsx | Route: /settings/user-management */}
...
{/* IMAGE: Add destination with Slack, Teams, Email options → /images/guides/managing-user-management/add-destination.png | UI: frontend-app/src/features/settings/components/shared/destinations/add-destination-button.tsx, destinations-pane.tsx | Route: /settings/desks/$deskId/notifications */}
