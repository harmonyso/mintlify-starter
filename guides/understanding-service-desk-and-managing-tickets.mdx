...
{/* IMAGE: Ticket table with desk selector → /images/guides/understanding-service-desk-and-managing-tickets/ticket-table-all-desks.png | UI: frontend-app/src/routes/tickets/desk.all.tsx | Route: /tickets/desk/all */}
...
{/* IMAGE: Create Ticket dialog with form fields → /images/guides/understanding-service-desk-and-managing-tickets/create-ticket-dialog.png | UI: frontend-app/src/components/common/forms/create-ticket-dialog.tsx, create-ticket-form.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Ticket preview panel with chat and properties → /images/guides/understanding-service-desk-and-managing-tickets/ticket-preview-panel.png | UI: frontend-app/src/features/service-desk/components/ticket-preview/resizable-ticket-preview.tsx, ticket-preview-controls.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Search canned responses dialog → /images/guides/understanding-service-desk-and-managing-tickets/canned-response-search.png | UI: frontend-app/src/features/service-desk/components/canned-response-search-dialog.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Respond with knowledge base solution modal → /images/guides/understanding-service-desk-and-managing-tickets/kb-solution-modal.png | UI: frontend-app/src/features/service-desk/components/kb-solution-modal.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Approvals section in ticket preview → /images/guides/understanding-service-desk-and-managing-tickets/ticket-approvals-section.png | UI: frontend-app/src/features/service-desk/components/ticket-preview/ticket-approvals-section.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Mandatory close comment dialog → /images/guides/understanding-service-desk-and-managing-tickets/close-ticket-comment-dialog.png | UI: frontend-app/src/features/service-desk/components/close-ticket-comment-dialog.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: SLA section in ticket preview → /images/guides/understanding-service-desk-and-managing-tickets/ticket-sla-section.png | UI: frontend-app/src/features/service-desk/components/ticket-preview/ticket-sla-section.tsx | Route: /tickets/desk/$deskId */}
