...
![Add source dropdown (Upload file, third-party)](/guides/managing-knowledge-base/screenshots/kb-add-source.png)
...
![Selection dialog with tree of spaces/pages](/guides/managing-knowledge-base/screenshots/kb-third-party-dialog.png)
...
![Knowledge Base table with articles and sync status](/guides/managing-knowledge-base/screenshots/kb-table-sync-status.png)
...
![KB permissions dialog with Authorized groups](/guides/managing-knowledge-base/screenshots/kb-permissions-dialog.png)
...
![Knowledge Base table with selection and Delete button](/guides/managing-knowledge-base/screenshots/kb-bulk-delete.png)
