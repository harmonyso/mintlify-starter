...
{/* IMAGE: People data table with toolbar and filters → /guides/managing-people/screenshots/people-list.png | UI: frontend-app/src/routes/people/index.tsx | Route: /people */}
...
{/* IMAGE: Employee profile with Overview tab → /guides/managing-people/screenshots/employee-profile.png | UI: frontend-app/src/routes/people/$employeeId.tsx | Route: /people/$employeeId */}
...
{/* IMAGE: Manage Groups dialog with group selector → /guides/managing-people/screenshots/manage-groups-dialog.png | UI: frontend-app/src/features/people/components/employee-details/manage-groups-dialog.tsx | Route: /people/$employeeId */}
...
{/* IMAGE: People toolbar with Export button → /guides/managing-people/screenshots/people-toolbar-export.png | UI: frontend-app/src/routes/people/index.tsx | Route: /people */}
