...
![Settings > Integrations with integration cards](/guides/connecting-and-managing-integrations/screenshots/integrations-connect.png)
...
![OAuth authorization page (Slack, Okta, etc.) — captured manually during Connect flow](/guides/connecting-and-managing-integrations/screenshots/oauth-authorization.png)
...
![Integration config modal with form fields and Save Changes](/guides/connecting-and-managing-integrations/screenshots/integration-config-form.png)
...
![Multi-instance modal with Create instance and instance list](/guides/connecting-and-managing-integrations/screenshots/multi-instance-modal.png)
