...
![Widget library side panel](/guides/working-with-dashboard-widgets/screenshots/widget-library.png)
...
![Dashboard with date range selector](/guides/working-with-dashboard-widgets/screenshots/date-range-selector.png)
