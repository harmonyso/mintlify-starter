...
{/* IMAGE: Widget library side panel → /guides/working-with-dashboard-widgets/screenshots/widget-library.png | UI: frontend-app/src/features/dashboard/components/widget-library.tsx | Route: /dashboard */}
...
{/* IMAGE: Dashboard with date range selector → /guides/working-with-dashboard-widgets/screenshots/date-range-selector.png | UI: frontend-app/src/features/dashboard/components/date-range-selector.tsx | Route: /dashboard */}
