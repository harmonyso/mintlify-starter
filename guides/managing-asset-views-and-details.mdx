...
![Warehouse view with aggregated counts](/images/guides/managing-asset-views-and-details/warehouse-view.png)
...
![Quick filter cards (Unassigned, EOL, MacOS, etc.)](/images/guides/managing-asset-views-and-details/asset-quick-filters.png)
...
![Asset detail page Overview with header and cards](/images/guides/managing-asset-views-and-details/asset-detail-overview.png)
...
![Retirement modal with reason selection](/images/guides/managing-asset-views-and-details/retirement-modal.png)
...
![Activity log sheet with event list](/images/guides/managing-asset-views-and-details/activity-log-sheet.png)
