...
{/* IMAGE: Warehouse view with aggregated counts → /images/guides/managing-asset-views-and-details/warehouse-view.png | UI: frontend-app/src/routes/assets/index.tsx, features/asset-management/components/warehouse-columns.tsx | Route: /assets */}
...
{/* IMAGE: Quick filter cards (Unassigned, EOL, MacOS, etc.) → /images/guides/managing-asset-views-and-details/asset-quick-filters.png | UI: frontend-app/src/features/asset-management/components/asset-quick-filters.tsx | Route: /assets */}
...
{/* IMAGE: Asset detail page Overview with header and cards → /images/guides/managing-asset-views-and-details/asset-detail-overview.png | UI: frontend-app/src/routes/assets/$assetId.tsx | Route: /assets/$assetId */}
...
{/* IMAGE: Retirement modal with reason selection → /images/guides/managing-asset-views-and-details/retirement-modal.png | UI: frontend-app/src/features/asset-management/components/retirement-modal.tsx | Route: /assets/$assetId */}
...
{/* IMAGE: Activity log sheet with event list → /images/guides/managing-asset-views-and-details/activity-log-sheet.png | UI: frontend-app/src/features/asset-management/components/activity-log/activity-log-sheet.tsx | Route: /assets/$assetId */}
