...
{/* IMAGE: Ticket table with desk selector → /guides/understanding-service-desk-and-managing-tickets/screenshots/ticket-table-all-desks.png | UI: frontend-app/src/routes/tickets/desk.all.tsx | Route: /tickets/desk/all */}
...
{/* IMAGE: Create Ticket dialog with form fields → /guides/understanding-service-desk-and-managing-tickets/screenshots/create-ticket-dialog.png | UI: frontend-app/src/components/common/forms/create-ticket-dialog.tsx, create-ticket-form.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Ticket preview panel with chat and properties → /guides/understanding-service-desk-and-managing-tickets/screenshots/ticket-preview-panel.png | UI: frontend-app/src/features/service-desk/components/ticket-preview/resizable-ticket-preview.tsx, ticket-preview-controls.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: Search canned responses dialog → /guides/understanding-service-desk-and-managing-tickets/screenshots/canned-response-search.png | UI: frontend-app/src/features/service-desk/components/canned-response-search-dialog.tsx | Route: /tickets/desk/$deskId */}
...
{/* IMAGE: SLA section in ticket preview → /guides/understanding-service-desk-and-managing-tickets/screenshots/ticket-sla-section.png | UI: frontend-app/src/features/service-desk/components/ticket-preview/ticket-sla-section.tsx | Route: /tickets/desk/$deskId */}
