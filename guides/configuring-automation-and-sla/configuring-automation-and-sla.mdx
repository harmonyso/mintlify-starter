...
![Automation tab with ticket assignment (round-robin, least-loaded, etc.)](/guides/configuring-automation-and-sla/screenshots/auto-assignment.png)
...
![Automation tab with inactivity-based closure options](/guides/configuring-automation-and-sla/screenshots/auto-close-settings.png)
...
![SLA tab with response and resolution targets by priority](/guides/configuring-automation-and-sla/screenshots/sla-policies.png)
