...
{/* IMAGE: Integrations list with category filter and cards → /images/guides/understanding-integrations/integrations-list.png | UI: frontend-app/src/features/settings/components/integrations/integrations-pane.tsx | Route: /settings/integrations */}
...
{/* IMAGE: Integration card with Connected badge → /images/guides/understanding-integrations/integration-connected.png | UI: frontend-app/src/features/settings/components/integrations/integration-card.tsx | Route: /settings/integrations */}
...
{/* IMAGE: Integration card with Connect button → /images/guides/understanding-integrations/integration-connect.png | UI: frontend-app/src/features/settings/components/integrations/integration-card.tsx | Route: /settings/integrations */}
