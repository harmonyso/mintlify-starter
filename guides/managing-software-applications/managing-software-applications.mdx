...
{/* IMAGE: Software list with toolbar and filters → /guides/managing-software-applications/screenshots/software-list.png | UI: frontend-app/src/routes/software/index.tsx | Route: /software */}
...
{/* IMAGE: Application detail page with Licenses and users → /guides/managing-software-applications/screenshots/software-detail.png | UI: frontend-app/src/routes/software/$appId.tsx | Route: /software/$appId */}
...
{/* IMAGE: Add license form with seats, cost, billing cycle → /guides/managing-software-applications/screenshots/add-license-form.png | UI: frontend-app/src/features/software-management/components/add-edit-license-modal.tsx | Route: /software/$appId */}
...
{/* IMAGE: Assign App Permissions dialog → /guides/managing-software-applications/screenshots/assign-app-permissions.png | UI: frontend-app/src/features/software-management/components/assign-app-permissions-modal.tsx | Route: /software/$appId */}
...
{/* IMAGE: Software bulk actions toolbar with Change status → /guides/managing-software-applications/screenshots/software-bulk-actions.png | UI: frontend-app/src/features/software-management/components/bulk-actions.tsx | Route: /software */}
...
{/* IMAGE: Software toolbar with Export button → /guides/managing-software-applications/screenshots/software-toolbar-export.png | UI: frontend-app/src/routes/software/index.tsx | Route: /software */}
