...
{/* IMAGE: Portal home with hero and Tabs (Tickets, Approvals) → /images/guides/using-the-harmony-portal/portal-home.png | UI: frontend-app/src/routes/portal/index.tsx | Route: /portal */}
...
{/* IMAGE: Hero with chat input and branding → /images/guides/using-the-harmony-portal/portal-hero-chat.png | UI: frontend-app/src/routes/portal/index.tsx, features/portal/v2/components/chat-input-v2.tsx | Route: /portal */}
...
{/* IMAGE: Threads view with sidebar and conversation → /images/guides/using-the-harmony-portal/portal-threads.png | UI: frontend-app/src/features/portal/v2/components/threads-sidebar-v2.tsx, thread-view-v2.tsx | Route: /portal/threads */}
...
{/* IMAGE: Portal Tickets tab with ticket list → /images/guides/using-the-harmony-portal/portal-tickets-tab.png | UI: frontend-app/src/features/portal/components/tickets-section.tsx | Route: /portal */}
...
{/* IMAGE: Portal ticket detail with Chat and Activity tabs → /images/guides/using-the-harmony-portal/portal-ticket-detail.png | UI: frontend-app/src/routes/portal/tickets/$ticketId/$slug/index.tsx | Route: /portal/tickets/$ticketId/$slug */}
...
{/* IMAGE: Portal Approvals tab with Approve/Deny actions → /images/guides/using-the-harmony-portal/portal-approvals-tab.png | UI: frontend-app/src/features/portal/components/approvals-section.tsx, approval-approve-modal.tsx, approval-deny-modal.tsx | Route: /portal */}
