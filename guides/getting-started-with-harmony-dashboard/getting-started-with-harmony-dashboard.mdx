...
![Main sidebar with core sections](/guides/getting-started-with-harmony-dashboard/screenshots/sidebar-sections.png)
...
![Default dashboard home view with widgets](/guides/getting-started-with-harmony-dashboard/screenshots/dashboard-home.png)
...
![Command palette with search](/guides/getting-started-with-harmony-dashboard/screenshots/command-palette.png)
