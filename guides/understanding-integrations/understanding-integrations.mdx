...
{/* IMAGE: Integrations list with category filter and cards → /guides/understanding-integrations/screenshots/integrations-list.png | UI: frontend-app/src/features/settings/components/integrations/integrations-pane.tsx | Route: /settings/integrations */}
...
{/* IMAGE: Integration card with Connected badge → /guides/understanding-integrations/screenshots/integration-connected.png | UI: frontend-app/src/features/settings/components/integrations/integration-card.tsx | Route: /settings/integrations */}
...
{/* IMAGE: Integration card with Connect button → /guides/understanding-integrations/screenshots/integration-connect.png | UI: frontend-app/src/features/settings/components/integrations/integration-card.tsx | Route: /settings/integrations */}
