...
{/* IMAGE: Automation tab with ticket assignment (round-robin, etc.) → /images/guides/configuring-automation-and-sla/auto-assignment.png | UI: frontend-app/src/features/settings/components/teams/auto-assign-section.tsx | Route: /settings/desks/$deskId/automation */}
...
{/* IMAGE: Automation tab with inactivity-based closure options → /images/guides/configuring-automation-and-sla/auto-close-settings.png | UI: frontend-app/src/features/settings/components/automation/auto-close-settings-section.tsx, automation-pane.tsx | Route: /settings/desks/$deskId/automation */}
...
{/* IMAGE: SLA tab with response/resolution targets by priority → /images/guides/configuring-automation-and-sla/sla-policies.png | UI: frontend-app/src/features/settings/components/sla/sla-pane.tsx | Route: /settings/desks/$deskId/sla */}
