...
![Bidirectional sync toggle in integration config](/guides/configuring-integration-sync-and-credentials/screenshots/sync-toggle.png)
...
![Integration cards showing Connected state](/guides/configuring-integration-sync-and-credentials/screenshots/integration-status.png)
...
![Integration modal with credential fields](/guides/configuring-integration-sync-and-credentials/screenshots/integration-credentials-modal.png)
