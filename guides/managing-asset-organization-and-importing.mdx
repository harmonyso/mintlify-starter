...
{/* IMAGE: Asset detail page with Asset details card (Ownership, Assigned to) → /images/guides/managing-asset-organization-and-importing/asset-detail-org-fields.png | UI: frontend-app/src/routes/assets/$assetId.tsx | Route: /assets/$assetId */}
...
{/* IMAGE: Asset list with checkboxes and bulk actions bar → /images/guides/managing-asset-organization-and-importing/asset-bulk-actions.png | UI: frontend-app/src/features/asset-management/components/assets-bulk-actions.tsx, assets-table/columns.tsx | Route: /assets */}
...
{/* IMAGE: Import dialog with template download → /images/guides/managing-asset-organization-and-importing/asset-import-dialog.png | UI: frontend-app/src/features/asset-management/components/import-assets-dialog.tsx | Route: /assets */}
...
{/* IMAGE: Assets toolbar with Import and Export buttons → /images/guides/managing-asset-organization-and-importing/assets-toolbar-export.png | UI: frontend-app/src/routes/assets/index.tsx | Route: /assets */}
