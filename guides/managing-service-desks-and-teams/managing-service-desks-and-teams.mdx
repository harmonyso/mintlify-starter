...
{/* IMAGE: Desks list with Create Desk button → /guides/managing-service-desks-and-teams/screenshots/desks-list.png | UI: frontend-app/src/features/settings/components/desks/desks-pane.tsx | Route: /settings/desks */}

{/* IMAGE: Create Desk modal (custom vs template) → /guides/managing-service-desks-and-teams/screenshots/create-desk-modal.png | UI: frontend-app/src/features/settings/components/desks/new-desk-form-dialog.tsx, desk-template-selector.tsx | Route: /settings/desks */}
...
{/* IMAGE: Desk overview with Email, Members, Automation, SLA tabs → /guides/managing-service-desks-and-teams/screenshots/desk-overview-tabs.png | UI: frontend-app/src/features/settings/components/desks/desk-configurations.tsx | Route: /settings/desks/$deskId */}
...
{/* IMAGE: Delete confirmation dialog with name confirmation → /guides/managing-service-desks-and-teams/screenshots/delete-desk-dialog.png | UI: frontend-app/src/features/settings/components/desks/delete-desk-dialog.tsx | Route: /settings/desks */}
...
{/* IMAGE: Members tab with Add Member and member list → /guides/managing-service-desks-and-teams/screenshots/members-tab.png | UI: frontend-app/src/features/settings/components/teams/members-and-teams-pane.tsx, members-section.tsx | Route: /settings/desks/$deskId/members */}
...
{/* IMAGE: Create Team dialog and Teams list → /guides/managing-service-desks-and-teams/screenshots/create-team-dialog.png | UI: frontend-app/src/features/settings/components/teams/create-team-dialog.tsx, teams-pane.tsx | Route: /settings/desks/$deskId/members */}
...
{/* IMAGE: Working hours section with 24/7 and Custom options → /guides/managing-service-desks-and-teams/screenshots/working-hours.png | UI: frontend-app/src/features/settings/components/teams/working-hours-section.tsx | Route: /settings/desks/$deskId/sla or /settings/desks/$deskId/teams/$teamId */}
