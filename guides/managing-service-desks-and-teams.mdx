...
{/* IMAGE: Desks list with Create Desk button → /images/guides/managing-service-desks-and-teams/desks-list.png | UI: frontend-app/src/features/settings/components/desks/desks-pane.tsx | Route: /settings/desks */}

{/* IMAGE: Create Desk modal (custom vs template) → /images/guides/managing-service-desks-and-teams/create-desk-modal.png | UI: frontend-app/src/features/settings/components/desks/new-desk-form-dialog.tsx, desk-template-selector.tsx | Route: /settings/desks */}
...
{/* IMAGE: Desk overview with Email, Members, Automation, SLA tabs → /images/guides/managing-service-desks-and-teams/desk-overview-tabs.png | UI: frontend-app/src/features/settings/components/desks/desk-configurations.tsx | Route: /settings/desks/$deskId */}
...
{/* IMAGE: Delete confirmation dialog with name confirmation → /images/guides/managing-service-desks-and-teams/delete-desk-dialog.png | UI: frontend-app/src/features/settings/components/desks/delete-desk-dialog.tsx | Route: /settings/desks */}
...
{/* IMAGE: Members tab with Add Member and member list → /images/guides/managing-service-desks-and-teams/members-tab.png | UI: frontend-app/src/features/settings/components/teams/members-and-teams-pane.tsx, members-section.tsx | Route: /settings/desks/$deskId/members */}
...
{/* IMAGE: Create Team dialog and Teams list → /images/guides/managing-service-desks-and-teams/create-team-dialog.png | UI: frontend-app/src/features/settings/components/teams/create-team-dialog.tsx, teams-pane.tsx | Route: /settings/desks/$deskId/members */}
...
{/* IMAGE: Working hours section with 24/7 and Custom options → /images/guides/managing-service-desks-and-teams/working-hours.png | UI: frontend-app/src/features/settings/components/teams/working-hours-section.tsx | Route: /settings/desks/$deskId/sla or /settings/desks/$deskId/teams/$teamId */}
