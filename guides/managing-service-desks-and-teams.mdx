...
1. Go to **Settings** → **Desks** (`/settings/desks`).
2. Click **Create Desk**.
...
From the desk overview (`/settings/desks/$deskId`), you can configure:
...
1. Open the team from the Teams list (`/settings/desks/$deskId/teams/$teamId`).
...
<CardGroup cols={2}>
  ...
  <Card title="Ticket Settings & Users" icon="cog" href="/guides/managing-ticket-settings-and-users">
    Custom fields, tags, canned responses, and notifications.
  </Card>
